      ...
      <div  class="login-form" >
        <img src='./imges/LinkProject-10.png'class="pt-3 mx-auto d-block mb-2" width="260px" alt="linksale_logo">
          ...
          <form action="signup_db.php" method="post"> 
            ...
            <div class="alert alert-danger" role="alert"><?php echo $_SESSION['userErr']; 
                 unset($_SESSION['userErr']); ?></div>
            <?php } ?>
            <?php if(isset($_SESSION['emailErr'])) { ?>
            <div class="alert alert-danger" role="alert"><?php echo $_SESSION['emailErr']; 
                 unset($_SESSION['emailErr']); ?></div>
            <?php } ?>
            <?php if(isset($_SESSION['passwordErr'])) { ?>
            <div class="alert alert-danger" role="alert"><?php echo $_SESSION['passwordErr']; 
                 unset($_SESSION['passwordErr']); ?></div>
            <?php } ?>
              <div class="mb-1">
                <label for="username" class="visually-hidden">username</label>
                <input type="text" class="mb-3 form-control font" name="username" placeholder="ชื่อผู้ใช้">
              </div>
              <div class="mb-1">
                <label for="inputEmail" class="visually-hidden">Email address</label>
                <input type="text" class="mb-3 form-control" name="email" id="inputEmail" placeholder="อีเมล" required>
              </div>
              <div class="mb-1">
                <label for="psw" class="visually-hidden">Password</label>
                <input type="password" class="mb-3 form-control" name="password" id="inputPassword"  placeholder="รหัสผ่าน" required>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="phone_number" id="phone_number" placeholder="เบอร์โทร" required>
              </div>
              <div class="col-md-4 mb-3">
                <select name="role" class="company_name form-control inputselect">
                  <option></option>
                  <option>admin</option>
